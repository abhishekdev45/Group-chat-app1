    ...
    chatHistory.forEach((ele) => {
        ...
        if (ele.userId == userId) {
            ...
            <div class="col-12 mb-2 pe-0">
                ...
                messageText += `                            
                <div class="col-12 mb-2 pe-0">
                    <div class="card p-2 float-end rounded-4 self-chat-class" style="background-color:  #c0c8cf;">
            ...
            if(ele.isImage){
                ...
                messageText += `                            
                <div class="col-12 mb-2 pe-0">
                    <div class="card p-2 float-start rounded-4 chat-class" style="background-color: #e0e4e7 ;">
                        <p class="text-muted my-0"><small>${ele.name}</small></p>
                        <p class="my-0">${ele.message}</p>
...
async function ShowGroup() {
    try {
        ...
        <button class="list-group-item btn-secondary list-group-item-action py-2" 
            data-bs-toggle="list">
